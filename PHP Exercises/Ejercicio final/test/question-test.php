...
class QuestionTest extends TestCase
{
  ...
  public function testQuestion()
  {
    ...
    // Question constructor does it job
    $question = new Question("Test question","question for testing","answer...");
    ...
    "<input type='text' name='Test question' placeholder='answer...' value=''>" . "<br/>");
  }
