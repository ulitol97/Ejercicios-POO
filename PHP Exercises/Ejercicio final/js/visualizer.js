...
function drawCharts() {
    // Create data tables
    var journeyAndVisitData = new google.visualization.DataTable();
    var scoreData = new google.visualization.DataTable();
    var satisfactionResults = {};
    ...
    // Set chart options
    var journeyAndVisitOptions = { 'title': 'Feeling towards the journey and the monuments seen in ' + visitedPlace,
        'width': 400,
        'height': 300 };
    var scoreOptions = { 'title': 'Score (0 - 10) given to the overall trip',
        'width': 500,
        'height': 300 };
    // Instantiate and draw our charts, passing in some options.
    var journeyAndVisitChart = new google.visualization.PieChart(pieChartDiv);
    var scoreChart = new google.visualization.ColumnChart(barChartDiv);
    journeyAndVisitChart.draw(journeyAndVisitData, journeyAndVisitOptions);
    scoreChart.draw(scoreData, scoreOptions);
}
var graphsDiv = document.getElementById("graph-wrapper");
if (graphsDiv != null) {
    ...
    var visitedPlace = incomingData.questions[0].answer;
    loadGoogleCharts();
}
